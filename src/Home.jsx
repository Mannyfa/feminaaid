...
const Marquee = () => {
  ...
  return (
    // Changed bg to your Blue #009EE3 for contrast
  ...
  <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
    <div className="flex items-center justify-between mb-4">
      <div className="flex items-center gap-3">
        {/* Gradient Avatar using your Pink and Blue */}
        <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#E62C79] to-[#009EE3] flex items-center justify-center text-white font-bold">
          {name[0]}
        </div>
        <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        {[
          ...
          <div key={idx} className="p-4">
            {/* Text Gradient using Pink #E62C79 and Blue #009EE3 */}
        ...
        <form ref={form} onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div>
            ...
            <input 
              ...
              type="text" 
              required 
              className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#E62C79] outline-none transition-all" 
          ...
          <div>
            ...
            <input 
              ...
              type="email" 
              required 
              className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#E62C79] outline-none" 
          ...
          <div className="pt-4">
            <button 
              ...
              className="relative w-full inline-flex items-center justify-center p-0.5 mb-2 overflow-hidden text-sm font-medium text-gray-900 rounded-xl group bg-gradient-to-br from-[#E62C79] to-[#009EE3] group-hover:from-[#E62C79] group-hover:to-[#009EE3] hover:text-white focus:ring-4 focus:outline-none focus:ring-pink-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
...
const TeamCard = ({ name, role, bio, imageId, index, total }) => {
    ...
    const baseStyle = `relative bg-white p-8 rounded-2xl shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] border border-slate-100 max-w-md w-full mx-auto transition-all duration-500 ease-out group hover:z-50 hover:scale-105 hover:shadow-[0_20px_60px_-15px_rgba(230,44,121,0.3)]`;
    ...
    return (
      <div className={`${baseStyle} ${stackStyle}`}>
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#E62C79]/0 to-[#009EE3]/0 rounded-2xl transition-all duration-500 group-hover:from-[#E62C79]/5 group-hover:to-[#009EE3]/5 -z-10"></div>
        
        <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start">
          {/* Avatar Image with Gradient Border */}
          <div className="flex-shrink-0 p-1 rounded-full bg-gradient-to-br from-[#E62C79] to-[#009EE3] shadow-sm">
            <img 
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-[#E62C79] font-medium text-sm mb-3">{role}</p>
            ...
            <div className="flex gap-3 justify-center sm:justify-start text-slate-400">
               <a href="#" className="hover:text-[#E62C79] transition-colors"><Linkedin className="w-4 h-4"/></a>
               <a href="#" className="hover:text-[#E62C79] transition-colors"><XIcon className="w-4 h-4"/></a>
            </div>
          </div>
        </div>
      </div>
...
// --- COMPONENT: The Team Section ---
const TeamSection = () => {
    const members = [
      { name: "Dr. Alero Ejeye", role: "Founder & Lead Mentor", bio: "Amina is a cardiologist and advocate for women's health, founding the network to bridge the gap in medical leadership.", imageId: "SibwBVCA7dY" },
    ...
    return (
      ...
      <section id="team" className="py-24 bg-white overflow-hidden relative">
         {/* Subtle background elements using your colors */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
            <div className="absolute top-[10%] right-[-10%] w-64 h-64 bg-[#ED70A4]/30 rounded-full mix-blend-multiply filter blur-3xl animate-blob"></div>
            <div className="absolute bottom-[10%] left-[-10%] w-64 h-64 bg-[#009EE3]/20 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000"></div>
        </div>
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <nav className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            {/* LOGO SECTION - ADDED IMAGE PLACEHOLDER HERE */}
            <div className="flex-shrink-0 flex items-center gap-2">
              {/* Replace the src below with your actual imported logo variable */}
              <img 
                src={logo} 
                alt="Femina Logo" 
                className="h-10 w-auto object-contain"
              />
              {/* If you don't have a logo yet, you can keep the text next to it or remove it */}
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button 
                ...
                // Button now uses your Pink #E62C79
      ...
      <section className="relative overflow-hidden pt-16 pb-20 lg:pt-32 lg:pb-32">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full z-0 pointer-events-none">
          <div className="absolute top-20 left-10 w-72 h-72 bg-[#ED70A4]/30 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
          <div className="absolute top-20 right-10 w-72 h-72 bg-[#009EE3]/20 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
          <div className="absolute -bottom-8 left-1/2 w-72 h-72 bg-[#E62C79]/30 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
        </div>

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-[#ED70A4]/10 border border-[#ED70A4]/20 text-[#E62C79] text-sm font-medium mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={() => setIsRegisterOpen(true)}
              className="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-full group bg-gradient-to-br from-[#E62C79] to-[#009EE3] group-hover:from-[#E62C79] group-hover:to-[#009EE3] hover:text-white focus:ring-4 focus:outline-none focus:ring-pink-200 shadow-lg shadow-pink-500/30"
            >
      ...
      {/* Footer */}
      {/* Updated Background to gradient of your Pink #E62C79 flowing to Blue #009EE3 */}
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="space-y-4">
               <div className="flex items-center gap-2 mb-4">
                 {/* Replaced F square with image placeholder for footer logo */}
                 <img 
                    src="https://placehold.co/100x100/white/E62C79?text=LOGO" 
                    alt="Femina Logo" 
